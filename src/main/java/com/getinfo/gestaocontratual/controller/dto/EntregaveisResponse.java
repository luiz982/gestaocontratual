...
public record EntregaveisResponse(Long idEntregavel, String nome, Date dtInicio, Date dtFim, StatusEntregavel status, String descricao ,List<ColaboradorResponse> colaborador) {
